              ...
              {FILTERS.map(({ key, label }) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-1.5 text-[12px] font-medium px-3 py-1 rounded-[7px] border transition-colors duration-100 ${filter === key ? t.tabActive : `${t.tabInactive} border-transparent`
                      }`}
                  >
                    {label}
                    {count > 0 && (
